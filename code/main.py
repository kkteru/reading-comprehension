...
tf.app.flags.DEFINE_string("na_bias", 'w', "How to add the no-answer bias? w: affecting the weights; b: simple bias to treshold answer probability")
...
def main(unused_argv):
    ...
    if FLAGS.mode == "train":
        ...
        with tf.Session(config=config) as sess:
            ...
            logging.info("F1 : %.5f, EM: %.5f" % (f1_total, em_total))
